...
统一介绍 Sa-Token、Shiro、OIDC/Keycloak、SubjectProvider、route protection、401/403、清理。先用 ddd4j-javalin-version-selection 确认维护线，再读取当前分支源码。

## 核心范围

Sa-Token、Shiro、OIDC/Keycloak、SubjectProvider、route protection、401/403、清理。
...
- “使用 `$ddd4j-javalin-auth` 分析我当前项目应该采用的实现和配置。”
- “使用 `$ddd4j-javalin-auth` 对照当前源码审查现有用法。”
- “使用 `$ddd4j-javalin-auth` 给出实现选择、证据状态和剩余风险。”
