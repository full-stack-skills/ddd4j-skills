...
description: Use when choosing a ddd4j-javalin maintenance line based on Javalin, ddd4j, JDK, Maven, and POM model constraints.
license: Apache-2.0
---
...
统一介绍 6.7.x→Javalin 6.7/ddd4j 1/JDK17/Maven3；7.1.x→Javalin7.1/ddd4j 2/JDK17/Maven3；7.2.x→Javalin7.2/ddd4j3/JDK21/Maven4。先用 ddd4j-javalin-version-selection 确认维护线，再读取当前分支源码。

## 核心范围

6.7.x→Javalin 6.7/ddd4j 1/JDK17/Maven3；7.1.x→Javalin7.1/ddd4j 2/JDK17/Maven3；7.2.x→Javalin7.2/ddd4j3/JDK21/Maven4。
...
- “使用 `$ddd4j-javalin-version-selection` 分析我当前项目应该采用的实现和配置。”
- “使用 `$ddd4j-javalin-version-selection` 对照当前源码审查现有用法。”
- “使用 `$ddd4j-javalin-version-selection` 给出实现选择、证据状态和剩余风险。”
