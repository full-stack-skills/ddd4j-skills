...
统一介绍 Spring MVC、WebFlux、Context、错误、认证、Validation、幂等、CORS、Readiness，不按单个 artifact 拆技能。使用前先通过 ddd4j-boot-version-selection 确认维护线。

## 核心范围

Spring MVC、WebFlux、Context、错误、认证、Validation、幂等、CORS、Readiness。
...
- “使用 `$ddd4j-boot-web` 分析我当前项目应该采用的实现和配置。”
- “使用 `$ddd4j-boot-web` 对照当前源码审查现有用法。”
- “使用 `$ddd4j-boot-web` 给出实现选择、证据状态和剩余风险。”
